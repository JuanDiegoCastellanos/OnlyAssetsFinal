...
namespace OnlyAssetsFinal.Migrations
{
    ...
    [Migration("20221129191020_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlyAssetsFinal.Models.Account", b =>
                {
                    ...
                    b.Property<string>("CountryCreation")
                        .IsRequired()
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("OnlyAssetsFinal.Models.Account", b =>
                {
                    b.HasOne("OnlyAssetsFinal.Models.Person", "Person")
                        .WithMany("Accounts")
                        .HasForeignKey("PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OnlyAssetsFinal.Models.Role", "Role")
                        .WithMany("Accounts")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OnlyAssetsFinal.Models.Asset", b =>
                {
                    b.HasOne("OnlyAssetsFinal.Models.Creator", "Creator")
                        .WithMany("Assets")
